...
const Sidebar = ({ onClose }: { onClose?: () => void }) => {
  return (
    <div className="space-y-4 md:space-y-6 relative z-20 flex flex-col h-full">
      {/* logo  */}
      <p className="hidden sm:block text-lg/7 font-semibold text-orange-700">
        Alert <span className="text-orange-600">Fox</span>
      </p>
...
function Layout({ children }: { children: ReactNode }) {
  ...
  return (
    <div className="relative h-screen flex flex-col md:flex-row bg-white overflow-hidden">
      {/* side for desktop  */}
      <div className="hidden md:block w-64 lg:w-80 border-r border-gray-100 p-6 h-full text-orange-700 relative z-10">
        <Sidebar />
      </div>
